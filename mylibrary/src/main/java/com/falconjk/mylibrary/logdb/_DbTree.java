...
import com.falconjk.mylibrary.logdb.core.LaunchSession;
import com.falconjk.mylibrary.logdb.core.Tree;
import com.falconjk.mylibrary.logdb.db.LogDatabase;
import com.falconjk.mylibrary.logdb.db.LogDbEntry;
        ...
        application.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityStopped(@NonNull Activity activity) {
                ...
                if (activityCount.decrementAndGet() == 0) {
                    Log.d(TAG, "quick save");
                    Disposable subscribe = Observable.interval(0, 300, TimeUnit.MILLISECONDS)
                            .subscribeOn(Schedulers.io())
                            .observeOn(Schedulers.io())
                            .subscribe(aLong -> forceFlushLogs(),
                                    throwable -> Log.e(TAG, "Error saving logs", throwable));
